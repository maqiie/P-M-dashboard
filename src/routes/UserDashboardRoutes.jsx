...
const UserDashboardRoutes = () => {
  return (
    <Routes>
      {/* Dashboard */}
      <Route path="dashboard" element={<ComingSoonPage title="User Dashboard" />} />

      {/* Projects */}
      <Route path="projects" element={<ProjectsPage />} />
      <Route path="projects/active" element={<ActiveProjectsPage />} />
      <Route path="projects/completed" element={<ComingSoonPage title="Completed Projects" />} />
      <Route path="projects/templates" element={<ComingSoonPage title="Project Templates" />} />

      {/* Tasks */}
      <Route path="tasks" element={<TasksPage />} />
      <Route path="tasks/active" element={<TasksPage initialView="active" />} />
      <Route path="tasks/my-tasks" element={<TasksPage initialView="my-tasks" />} />
      <Route path="tasks/overdue" element={<TasksPage initialView="overdue" />} />
      <Route path="tasks/completed" element={<TasksPage initialView="completed" />} />

      {/* Calendar */}
      <Route path="calendar" element={<CalendarPage />} />

      {/* Team */}
      <Route path="team" element={<Navigate to="team/overview" replace />} />
      <Route path="team/overview" element={<TeamOverview />} />
      <Route path="team/performance" element={<TeamPerformancePage />} />
      <Route path="team/schedule" element={<ComingSoonPage title="Team Schedule" />} />

      {/* Tenders */}
      <Route path="tenders" element={<TendersPage />} />
      <Route path="tenders/active" element={<ComingSoonPage title="Active Tenders" />} />
      <Route path="tenders/drafts" element={<ComingSoonPage title="Draft Tenders" />} />
      <Route path="tenders/history" element={<ComingSoonPage title="Tender History" />} />
      ...
      <Route path="reports/projects" element={<ComingSoonPage title="Project Reports" />} />
